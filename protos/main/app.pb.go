...
var file_app_proto_rawDesc = []byte{
	...
	0x64, 0x32, 0xcc, 0x02, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x24, 0x0a, 0x08, 0x52, 0x65,
	...
	0x12, 0x1e, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x08, 0x2e, 0x41, 0x75, 0x74,
	0x68, 0x47, 0x65, 0x74, 0x1a, 0x0a, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x45, 0x6d, 0x70, 0x74, 0x79,
...
var file_app_proto_depIdxs = []int32{
	...
	0, // 7: auth.Delete:input_type -> AuthGet
	3, // 8: auth.Register:output_type -> AuthEmpty
	0, // 9: auth.Login:output_type -> AuthGet
	4, // 10: auth.GetTicket:output_type -> AuthTicket
	2, // 11: auth.Activate:output_type -> AuthResponse
	3, // 12: auth.ChangePassword:output_type -> AuthEmpty
	3, // 13: auth.RequestPasswordReset:output_type -> AuthEmpty
	0, // 14: auth.ResetPassword:output_type -> AuthGet
	3, // 15: auth.Delete:output_type -> AuthEmpty
